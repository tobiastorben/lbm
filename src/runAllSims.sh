#!/bin/bash
mkdir ../res/cavity_re100 ../res/cylinder_re1 ../res/foil_neutral ../res/poiseuille ../res/cavity_re1000 ../res/cylinder_re100 ../res/foil_pitched ../res/couette ../res/cylinder_re50 ../res/foil_stall
